...
type ServiceInterface interface {
	List(ctx context.Context, input ListTasksInput) (*ListTasksOutput, error)
	...
	ListByTeam(ctx context.Context, input ListTasksByTeamInput) (*ListTasksByTeamOutput, error)
	ListByFilter(ctx context.Context, input ListTasksByFilterInput) (*ListTasksByFilterOutput, error)
}
...
func (s *service) List(ctx context.Context, input ListTasksInput) (*ListTasksOutput, error) {
	if input.Page < 1 {
		input.Page = 1
	}
...
func (s *service) Create(ctx context.Context, input CreateTaskInput) (*entity.Task, error) {
...
func (s *service) Update(ctx context.Context, input UpdateTaskInput) (*entity.Task, error) {
	if input.ID <= 0 {
		return nil, ErrInvalidTaskID
	}
...
func (s *service) ListByTeam(ctx context.Context, input ListTasksByTeamInput) (*ListTasksByTeamOutput, error) {
	if input.Page < 1 {
		input.Page = 1
	}
...
func (s *service) ListByFilter(ctx context.Context, input ListTasksByFilterInput) (*ListTasksByFilterOutput, error) {
